...
<div class="content-wrapper" style="background-image: linear-gradient(to right,#3a55da,#d0471e);">
    ...
    <div class="container" style="background-image: linear-gradient(to right,#3a55da,#d0471e);">
      <div class="row">
        <div class="col-md-12">
           <h1 class="text-center text-light" style="font-family: 'Grechen Fuemen', cursive;">EMPLOYE LEAVE VIEW</h1><br><br>
           <table class="table table-bordered  table-hover shadow">
              <tr>
                  <th>ID:</th>
                  <td><?php echo $a['l_id']; ?></td>
              </tr>
              <tr>
                  <th>VALID-FROM:</th>
           ...
           <center><a href="assign_leave_display.php" class="btn btn-success" style="background-image: linear-gradient(to right,#44220e,#1ed034);width: 120px; margin-bottom: 11px;">Back</a></center>
         </div> <!-- col md-12 end -->
    </div> <!-- row end -->
</div><!-- container end -->
    <!-- apna code end -->

      ...
      <div class="row">
        <div class="col-md-12">
           ...
           <table class="table table-bordered  table-hover shadow">
              ...
              <tr>
                  <th>EMPLOYE-ID:</th>
                  <td><?php echo $a['e_id'] ?></td>
              </tr>
              <tr>
                  <th>ASSIGNNED-BY:</th>
                  <td><?php echo $a['assigned_by'] ?></td>
              </tr>
              <tr>
                  <th>DATE-TIME:</th>
           ...
           <center><a href="task_display.php" class="btn btn-success" style="background-image: linear-gradient(to right,#44220e,#1ed034);width: 120px; margin-bottom: 11px;">Back</a></center>
         </div> <!-- col md-12 end -->
    </div> <!-- row end -->
</div><!-- container end -->
    <!-- apna code end -->
